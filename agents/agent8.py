...
class Agent:
    def __init__(self):
        ...
        self.frequency_distributions = sorted([fd for fd in FrequencyDistribution], key=lambda f: len(f.value))
    ...
    def encode(self, message: str):
        ...
        print("Freq Dist:", freq_dist_used)
        print("Encoded:", with_scheme)
